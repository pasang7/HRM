<div class="modal-dialog" role="document">
    <form action="" data-action="{{route('guest.clockin')}}" id="form-clockin">
        ...
        <div class="modal-content mcontent">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" style="--main_header_color : {{ $settings->main_header_color }};" class="btn btn-primary">Clockin</button>
            </div>
        </div>
    </form>
</div>
