...
@section('content')
    <form autocomplete="off" method="POST" action="{{ route('payroll-setting.income.assign') }}">
        @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="hdetails-wrapper">
                                            <div class="row">
                                                @if($income->calculation_method == 'percent')
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="number" name="percent_rate"
                                                            ...
                                                            value="{{ $income->percent_rate }}" readonly>
                                                        @error('percent_rate')
                                                ...
                                                @endif
                                                <div class="col-md-4 form-group">
                                                    <label for="assign_status" class="required">Add to All Employee?</label>
                                                </div>
                                                <div class="col-md-8 form-group">
                                                    <select class="form-control custom-form-control" id="assign_status" name="assign_status" onchange="changeAssign(this.value)">
                                            ...
                                            <div class="row" id="userListDiv">
                                                ...
                                                <div class="col-md-4" style="padding-bottom:10px;">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="{{ $staff->id }}" id="{{ $staff->slug }}" name="user_id[]"
                                                                {{ old('user_id', isset($assignedDetail->user_id) ? $assignedDetail->user_id : '') == $staff->id? 'checked="checked"': '' }} incomeId= "{{ $income->id }}" onclick="showAllowance(this.value)">
