<div class="modal-dialog" role="document">
    <form action="" data-action="{{route('attendance.clockout')}}" id="form-clockout">
        <input type="hidden" name="user_id" value="{{$user->id}}">
        <input type="hidden" name="attendance_id" value="{{$attendance->id}}">

        <div class="modal-content mcontent">
            <div class="modal-header mheader bg-grey">
                <h5 class="modal-title" id="changeHolidayLabel">Clockout</h5>
            ...
            <div class="modal-body mbody">
                ...
                <div class="form-group">
                    <input type="time" value="now" class="form-control custom-form-control" id="clockout-time" name="time"
            ...
            <div class="modal-footer">
                ...
                <button type="submit" style="--main_header_color : {{ $settings->main_header_color }};" class="btn btn-primary btn-sm">Clockout</button>
            </div>
        </div>
    </form>
</div>
