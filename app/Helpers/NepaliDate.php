...
class NepaliDate{
    ...
    public static $_nep_date = array('year' => '', 'month' => '', 'date' => '', 'day' => '', 'nmonth' => '', 'num_day' => '','total_day'=>'');
    ...
    public static function eng_to_nep($yy, $mm, $dd)
    {
        ...
        else
        {
            ...
            $numDay = $day;
            $total_day = self::$_bs[$y-2000][$m];
            self::$_nep_date['year']    = $y;
            self::$_nep_date['month']   = $m;
            self::$_nep_date['date']    = $total_nDays;
            self::$_nep_date['day']     = self::_get_day_of_week($day);
            self::$_nep_date['nmonth']  = self::_get_nepali_month($m);
            self::$_nep_date['num_day'] = $numDay;
            self::$_nep_date['total_day'] = $total_day;
            return self::$_nep_date;
        }
    }
    /**
    ...
    public static function nep_to_eng($yy, $mm, $dd)
    {
        ...
        else
        {
            ...
            $numDay = $day;
            self::$_eng_date['year']    = $y;
            self::$_eng_date['month']   = $m;
            self::$_eng_date['date']    = $total_eDays;
            self::$_eng_date['day']     = self::_get_day_of_week($day);
            self::$_eng_date['nmonth']  = self::_get_english_month($m);
            self::$_eng_date['num_day'] = $numDay;
            return self::$_eng_date;
        }
    }
    /**
     * Currently can only calculate the date between BS 2000-2089
     ...
     * @return int
     */
    public static function _get_total_nday($yy, $mm){
        $total_day = self::$_bs[$yy-2000][$mm];
        return $total_day;
    }
    // public static function _get_nep_info(){
    // }
}